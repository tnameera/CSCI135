...
int main() {
    ...
    int inPixel;
        ...
        /*  (0,0) (0,2),(2,0),(2,2)             
                0   1                0   1   2   3
            0  11   22           0   11  11  22  22                      
            1  33   44           1   11  11  22  22
                                 2   33  33  44  44 
                                 3   33  33  44  44  
        ...
        */
        ...
        for(int row = 0; row < h*2; row+=2) {
		    for(int col = 0; col < w*2; col+=2) {
                ...
                inPixel = img[row/2][col/2];

                out[row][col] = inPixel; // top left
                out[row+1][col] = inPixel; // bottom left
                out[row][col+1] = inPixel; // top right
                out[row+1][col+1] = inPixel; // bottom left
